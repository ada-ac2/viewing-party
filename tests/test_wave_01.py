...
def test_moves_movie_from_watchlist_to_empty_watched():
    ...
    # *******************************************************************************************
    for movies in updated_data["watched"]:
        if movies["title"] == MOVIE_TITLE_1:
            assert (movies["title"] == MOVIE_TITLE_1)
            assert (movies["genre"] == GENRE_1)
            assert (movies["rating"] == RATING_1)
